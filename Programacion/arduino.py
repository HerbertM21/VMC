    ...
    try:
        with open(fichero, 'a') as archivo:  # Abre el archivo en modo "añadir"
            while True:
                ...
                if len(datos) == 3:  # Ahora hay tres datos: humedad, temperatura y CO2
                    # Obtén los datos como números
                    ...
                    # Escribe los datos en el archivo en formato CSV inmediatamente
...
if __name__ == '__main__':
    ...
    try:
        # Limpia el archivo existente o crea uno nuevo
